...
| `validation`    | `ground_truth.jsonl`, `normalized/**`, criteria pack source material (non-contract input; materialized by the orchestrator)          | `criteria/manifest.json`, `criteria/criteria.jsonl`, `criteria/results.jsonl`                                                                                      |
