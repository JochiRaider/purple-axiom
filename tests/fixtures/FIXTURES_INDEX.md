...
This file exists to keep agent working sets small. It is a one-page map over the test data
directories in `tests/fixtures/` so developers and agents do not need to traverse the entire tree to
find test data.
