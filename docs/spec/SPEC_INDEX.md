...
This file exists to keep agent working sets small. It is a one-page map over the spec markdown
files in `docs/spec/` so agents do not need to load every document to find the authoritative section.
