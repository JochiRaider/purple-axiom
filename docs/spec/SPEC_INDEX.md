...
| "How are scenarios defined and compared?"          | `030_scenarios.md`                            | `031_plan_execution_model.md`, `035_validation_criteria.md`, `070_scoring_metrics.md` |
...
| "How do matrix/multi-target plans work?"           | `031_plan_execution_model.md`                 | `030_scenarios.md`, `ADR-0006`                                                        |

## Update rule (required)

When you add a new spec file, introduce a new concept, or add a new MUST/MUST NOT:

- Update this index to point to the authoritative spec file (and keep it one page).
- Prefer pointers to sections over duplicated prose.
