...
| Contract validation invalid  | Contract-backed artifact fails schema validation or parse                          | Stage-scoped contract-invalid reason code example: `scoring_summary_invalid` or `contract_validation_failed` | Prefer the stage-scoped code when defined; otherwise use `contract_validation_failed`.               |
