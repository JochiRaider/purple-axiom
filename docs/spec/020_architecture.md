...
This document describes the high-level architecture of Purple Axiom, including the primary
components, execution flow, and supported extension points.

## Overview

The system resolves lab inventory, executes scenarios, captures telemetry, normalizes events,
evaluates criteria, and produces detection and reporting outputs. Each component is designed to
preserve determinism and evidence for scoring and comparison.
