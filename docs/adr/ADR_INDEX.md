...
This file is a one-page map over ADR markdown files in `docs/adr/`.
It exists to keep agent working sets small and prevent “read the entire ADR set” behavior.
