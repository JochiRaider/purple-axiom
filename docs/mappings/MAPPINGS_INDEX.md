...
- If the change affects determinism, fixtures, or CI gates, also update `docs/spec/100_test_strategy_ci.md`
  (or the relevant stage spec) rather than expanding this index.